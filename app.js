...
function main(){
  ...
  // [question, correctAnswer(s), guesses, acceptable input(s)]
  var questions = [
  ...
  for(var i = 0; i<questions.length; i++) {
    ...
    var correctAnswer   = questions[i][1]; // correct correctAnswer(s)
    var guesses  = questions[i][2]; // number of guesses allowed
    var possibleAnswer = questions[i][3]; // acceptable input(s)
